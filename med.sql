...
create table seeker(sname varchar2(30),semail varchar2(30) primary key,spswrd
varchar2(30),sphone varchar2(10),saddress varchar2(100));
Stored Procedure to insert a record into seeker table table
Create or replace procedure new_seeker(sname varchar2,semail varchar2,spwd varchar2,sphone
varchar2,saddr varchar2) is
Begin
